-- Fix DELETE policy for meals table to allow event guests to delete proposed meals only
DROP POLICY IF EXISTS "Enable delete for event guests on proposed meals" ON public.meals;
